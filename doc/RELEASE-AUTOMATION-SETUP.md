...
This document covers the GitHub and npm setup required for the current Yantra release model:
...
Do this for every public package that Yantra publishes.
...
3. add a trusted publisher for the GitHub repository `yantraai/yantra`
...
2. revoke any personal automation token that used to publish Yantra
