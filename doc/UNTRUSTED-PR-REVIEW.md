...
This is intentionally separate from the normal Yantra dev image.
...
```sh
review-checkout-pr yantraai/yantra 432
cd /work/checkouts/yantraai-yantra/pr-432
```
...
## Preview the Yantra app from the PR
...
- Yantra's embedded PostgreSQL and local storage stay inside the container home volume via `YANTRA_HOME=/home/reviewer/.yantra-review`.
