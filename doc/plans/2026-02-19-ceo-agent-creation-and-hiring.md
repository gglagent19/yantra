...
- installed adapter list for this Yantra instance
...
## 8. New Skill: `yantra-create-agent`

Create new skill directory:

- `skills/yantra-create-agent/SKILL.md`
...
Also update `skills/yantra/SKILL.md` to reference this skill for hiring workflows.
...
- `yantra-create-agent` skill + docs updates
