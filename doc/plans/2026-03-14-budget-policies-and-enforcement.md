...
Yantra already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Yantra should implement next.

## Product Goals

Yantra should let operators:
...
For the next implementation pass, Yantra should enforce these defaults:
...
Yantra should separate subscription-included usage from billed spend:
...
Yantra should have two threshold classes:
...
Yantra must know that a project is budget-paused and enforce it.
...
Yantra must also block execution before new work starts.
