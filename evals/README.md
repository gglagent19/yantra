...
Eval framework for testing Yantra agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Yantra heartbeat skill:
