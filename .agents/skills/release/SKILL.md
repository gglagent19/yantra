...
name: release
description: >
  Coordinate a full Yantra release across engineering verification, npm,
...
Run the full Yantra maintainer release workflow, not just an npm publish.
...
7. If running through Yantra, you have issue context for status updates and follow-up task creation.
...
Yantra now uses a commit-driven release model:
...
npm view yantraai@canary version
```
...
- release summary in Yantra issue context
