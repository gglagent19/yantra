...
import { models as codexFallbackModels } from "@yantra/adapter-codex-local";
import { models as cursorFallbackModels } from "@yantra/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@yantra/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@yantra/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.YANTRA_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.YANTRA_OPENCODE_COMMAND = "__yantra_missing_opencode_command__";
