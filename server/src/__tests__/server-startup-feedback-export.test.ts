...
vi.mock("../config.js", () => ({
  loadConfig: vi.fn(() => ({
    ...
    databaseUrl: "postgres://yantra:yantra@127.0.0.1:5432/yantra",
    embeddedPostgresDataDir: "/tmp/yantra-test-db",
    embeddedPostgresPort: 54329,
    databaseBackupEnabled: false,
    databaseBackupIntervalMinutes: 60,
    databaseBackupRetentionDays: 30,
    databaseBackupDir: "/tmp/yantra-test-backups",
    serveUi: false,
    uiDevMiddleware: false,
    secretsProvider: "local_encrypted",
    secretsStrictMode: false,
    secretsMasterKeyFilePath: "/tmp/yantra-master.key",
    storageProvider: "local_disk",
    storageLocalDiskBaseDir: "/tmp/yantra-storage",
    storageS3Bucket: "yantra-test",
