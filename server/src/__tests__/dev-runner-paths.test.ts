...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Yantra state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".yantra/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/yantra",
      ),
    ).toBe(false);
