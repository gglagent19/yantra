...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@yantra/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: YantraPluginManifestV1, pluginDbId?: string): void;
