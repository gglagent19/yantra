 ...
 */
import type { CompanyPortabilityManifest } from "@yantra/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Yantra](https://yantra.ing)");
  lines.push("");
