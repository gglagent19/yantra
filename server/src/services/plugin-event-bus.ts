/**
 * PluginEventBus — typed in-process event bus for the Yantra plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@yantra/shared";
import type { PluginEvent, EventFilter } from "@yantra/plugin-sdk";
