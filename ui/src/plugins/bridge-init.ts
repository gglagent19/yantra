 ...
 *
 * This is placed on `globalThis.__yantraPluginBridge__` and consumed by
...
declare global {
  ...
  var __yantraPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__yantraPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__yantraPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
