 ...
 *
 * When the Yantra UI encounters an adapter type that doesn't have a
 ...
 * runtime dependencies, and Yantra's UI loads it on demand.
 */

import type { TranscriptEntry } from "@yantra/adapter-utils";
