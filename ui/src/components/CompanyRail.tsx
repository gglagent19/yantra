...
import type { Company } from "@yantra/shared";
import { CompanyPatternIcon } from "./CompanyPatternIcon";

const ORDER_STORAGE_KEY = "yantra.companyOrder";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-sidebar border-r border-border/10">
      {/* Yantra icon - aligned with top sections (implied line, no visible border) */}
