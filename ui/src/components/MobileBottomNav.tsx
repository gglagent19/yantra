...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  return (
    <nav
      className={cn(
        "fixed bottom-0 left-0 right-0 z-30 bg-sidebar/90 backdrop-blur-xl shadow-[0_-4px_24px_rgba(0,0,0,0.05)] transition-transform duration-200 ease-out md:hidden pb-[env(safe-area-inset-bottom)]",
