...
// Canonical type lives in @yantra/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@yantra/adapter-utils";
import type { CreateConfigValues } from "@yantra/adapter-utils";
