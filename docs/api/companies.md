...
Manage companies within your Yantra instance.
...
Company logo uploads use the normal Yantra attachment size limit.
...
| `logoUrl` | string | Optional Yantra asset content path for the stored logo image |
