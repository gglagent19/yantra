...
- Running a Python script that calls the Yantra API
...
1. Yantra spawns the configured command as a child process
2. Standard Yantra environment variables are injected (`YANTRA_AGENT_ID`, `YANTRA_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Yantra API and perform work.
