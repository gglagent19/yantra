...
Yantra supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Yantra?** Use `local_trusted` (the default)
