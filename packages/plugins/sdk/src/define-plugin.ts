/**
 * `definePlugin` — the top-level helper for authoring a Yantra plugin.
 *
...
// ---------------------------------------------------------------------------
// YantraPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `YantraPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@yantra/plugin-sdk";
