/**
 * `@yantra/plugin-sdk/ui` — Yantra plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@yantra/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@yantra/plugin-sdk/ui";
 *
