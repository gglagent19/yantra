...
import type { YantraPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@yantra/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: YantraPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@yantra/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
