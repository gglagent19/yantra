 ...
 * channel.
 *
 * The Yantra plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@yantra/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Yantra messages.
 */
...
/**
 * Yantra plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Yantra instance. */
    instanceId: string;
    /** Semver version of the running Yantra host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
