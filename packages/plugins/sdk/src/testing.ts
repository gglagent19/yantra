...
function requireCapability(manifest: YantraPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Yantra server runtime.
 */
