import type { PluginLauncherRegistration } from "@yantra/plugin-sdk";

export const PLUGIN_ID = "yantra-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".yantra-kitchen-sink-demo.txt",
} as const;
