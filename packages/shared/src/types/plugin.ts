...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within YantraPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Yantra host.
 *
...
export interface YantraPluginManifestV1 {
   ...
   */
  minimumYantraVersion?: PluginMinimumHostVersion;
