...
This document describes how `@yantra/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into Yantra logs/transcript parsing
