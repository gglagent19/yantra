...
export function createToolDefinitions(client: YantraApiClient): ToolDefinition[] {
  return [
    makeTool(
      "yantraMe",
      "Get the current authenticated Yantra actor details",
      z.object({}),
    ...
    makeTool(
      "yantraApiRequest",
      "Make a JSON request to an existing Yantra /api endpoint for unsupported operations",
      apiRequestSchema,
