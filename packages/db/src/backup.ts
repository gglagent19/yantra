...
function resolveYantraInstanceId(): string {
  const raw = process.env.YANTRA_INSTANCE_ID?.trim() || "default";
...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveYantraHomeDir(), "instances", resolveYantraInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveYantraHomeDir(), "instances", resolveYantraInstanceId(), "data", "backups");
}
